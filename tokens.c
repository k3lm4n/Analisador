...
const char TOKCONTINUE[][]={"continue"},"OKCONTINUE";
...
const char TOKMENORQUE[][]={"<","TOKMENORQUE"};
const char TOKMENIG[][]={"<=","TOKMENIG"};
const char TOKMAIOR[][]={">","TOKMAIOR"};
const char TOKMAOIG[][]={">=","TOKMAOIG"};
const char TOKIGUAL[][]={"==","TOKIGUAL"};
const char TOKDIFE[][]={"!=","TOKDIFE"};

/*OPERADORES LOGICOS*/

const char TOKAND[][]={"&&","TOKAND"};
const char TOKOR[][]={"||","TOKOR"};
const char TOKNOT[][]={"!","TOKNOT"};


/*OPERADORES DE INC E DEC*/

const char TOKINC[][]={"++","TOKINC"};
const char TOKDEC[][]={"--","TOKDEC"};

/*BITWISE*/

const char TOKANDBIT[][]={"&","TOKANDBIT"};
const char TOKORBIT[][]={"|","TOKORBIT"};
const char TOKOREX[][]={"^","TOKOREX"};
const char TOKDESESQ[][]={"<<","TOKDESESQ"};
const char TOKDESDIR[][]={">>","TOKDESDIR"};
const char TOKCOM[][]={"~","TOKCOM"};
